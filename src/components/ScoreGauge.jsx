...
export default function ScoreGauge() {
    return (
        <div className="bg-white text-gray-600 rounded-lg relative h-58 flex flex-col">
            <h3 className=" text-lg font-bold mb-6">Score de Risco</h3>
            <ResponsiveContainer width="100%" height="100%" className="scale-x-[-1]">
                <PieChart>
                    <Pie
                        data={data}
                        startAngle={180}
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center mt-16">
                ...
                {/* Legenda inferior */}
                <div className="flex justify-between items-center text-xs text-gray-400 w-full px-2 mt-1">
                    <span>0</span>
